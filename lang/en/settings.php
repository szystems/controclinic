...
return [
    ...
    'custom_domain' => [
        ...
        'no_domain' => 'No domain configured.',
        'removed' => 'Custom domain removed.',
        'remove_confirm' => 'Remove the custom domain? The portal will no longer respond at that domain.',
        'status_verified' => 'Verified domain: :domain',
        'status_pending' => 'Pending DNS verification',
        'dns_title' => 'Steps to connect your domain:',
        'dns_step1' => 'Add a CNAME record in your DNS provider pointing to :appDomain',
        'dns_step2' => 'Add a TXT record with the following value to verify ownership:',
        'verify_btn' => 'Verify domain',
        'upsell_title' => 'Custom domain — Enterprise plan',
        'upsell_desc' => 'Upgrade to the Enterprise plan to connect your own domain and deliver a fully branded experience to your patients.',
    ],
];
