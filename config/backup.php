...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Solo se hace backup de la base de datos.
                 * El código fuente está en el repositorio Git.
                 * Los archivos de pacientes deben respaldarse aparte (S3 nativo).
                 */
                'include' => [],
        ...
        'destination' => [
            ...
            'disks' => array_filter([
                'local',
                env('BACKUP_DISK') !== 'local' ? env('BACKUP_DISK') : null,
            ]),
    ...
    'notifications' => [
        'notifications' => [
            // Solo notificar en fallos — el éxito diario genera ruido innecesario
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL') ?: 'admin@controclinic.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hello@example.com'),
                'name' => env('MAIL_FROM_NAME', 'ControClinic'),
            ],
        ],
