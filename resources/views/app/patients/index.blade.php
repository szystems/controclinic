                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 flex flex-col sm:flex-row gap-4">
                        ...
                        <select class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                            <option value="">{{ __('patients.status') }}: Todos</option>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Comienza agregando tu primer paciente.</p>
                                        <div class="mt-6">
                                            <a href="{{ route('app.patients.create', ['clinic' => $currentClinic->slug]) }}"
                                               class="btn-primary">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
