    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full text-center">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                {{-- Icon --}}
                <div class="mx-auto flex items-center justify-center w-16 h-16 rounded-full bg-red-100 mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900 mb-2">
                    {{ __('appointments_mail.cancel_page_title') }}
                </h1>

                <p class="text-gray-600 mb-6">
                    {{ __('appointments_mail.cancel_page_message') }}
                </p>
                ...
                <p class="text-sm text-gray-500">
                    {{ __('appointments_mail.cancel_page_note') }}
                </p>
            </div>
        </div>
    </div>
