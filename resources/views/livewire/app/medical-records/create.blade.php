                        ...
                        <div class="mt-4 flex items-end gap-2 p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
                            <div class="flex-1">
                                ...
                                <select wire:model.live="selectedTemplateId"
                                        class="w-full rounded-md border-indigo-200 dark:border-indigo-700 bg-white dark:bg-gray-700 text-sm">
                                    <option value="">{{ __('templates.select_template') }}</option>
                                    @foreach($this->templatesForType as $tmpl)
                                        <option value="{{ $tmpl->id }}">
                                            {{ $tmpl->name }}{{ $tmpl->is_default ? ' ★' : '' }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
