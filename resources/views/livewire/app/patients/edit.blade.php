<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="{{ route('app.patients.show', ['clinic' => $currentClinic->slug, 'patient' => $patient->id]) }}" class="ml-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                            {{ $patient->full_name }}
                        </a>
                    </li>
                    <li class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700 dark:text-gray-300">{{ __('general.edit') }}</span>
                    </li>
                </ol>
            </nav>
        ...
        <form wire:submit="save">
            ...
            <div class="bg-amber-50 dark:bg-amber-900/20 rounded-lg shadow-sm border border-amber-200 dark:border-amber-700 p-6 mb-6">
                <h2 class="text-lg font-medium text-gray-900 dark:text-white mb-1 flex items-center gap-2">
                    <svg class="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                    </svg>
                    {{ __('patients.internal_notes') }}
                </h2>
                <p class="text-xs text-amber-700 dark:text-amber-400 mb-3">{{ __('patients.internal_notes_hint') }}</p>
                <div>
                    <textarea wire:model="internal_notes" id="internal_notes" rows="4"
                              class="block w-full rounded-lg border-amber-300 dark:border-amber-700 dark:bg-gray-700 dark:text-white shadow-sm focus:border-amber-500 focus:ring-amber-500 sm:text-sm"
                              placeholder="{{ __('patients.internal_notes_placeholder') }}"></textarea>
