<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Card -->
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 sm:p-8 relative">
            <div wire:loading.flex wire:target="nextStep,previousStep,completeOnboarding" class="absolute inset-0 z-10 items-center justify-center rounded-xl bg-white/80 dark:bg-gray-800/80">
            ...
            @if ($currentStep === 2)
                <div
                    x-data
                    x-init="
                        if (!$wire.browserTimezoneRefined) {
                            try {
                                const tz = Intl.DateTimeFormat().resolvedOptions().timeZone;
                                if (tz) $wire.refineTimezoneFromBrowser(tz);
                            } catch (e) {}
                        }
                    "
                >
